...
export function OpenShiftModal({ onClose }: OpenShiftModalProps) {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<OpenFormValues>({
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="modal-content">
            ...
            <div className="form-group">
              ...
              <input id="opening_cash" type="number" className="form-control" {...register("opening_cash")} />
              {errors.opening_cash && <p className="form-error">{errors.opening_cash.message}</p>}
            </div>
            <div className="form-group">
              <label htmlFor="open_note">Ghi chú (tùy chọn)</label>
              <input id="open_note" type="text" className="form-control" placeholder="VD: Ca sáng..." {...register("note")} />
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="modal-content">
            ...
            <div className="form-group">
              ...
              {errors.closing_cash && <p className="form-error">{errors.closing_cash.message}</p>}
            </div>
            <div className="form-group">
              <label htmlFor="close_note">Ghi chú (tùy chọn)</label>
              <input id="close_note" type="text" className="form-control" placeholder="VD: Đủ quỹ, không phát sinh..." {...register("note")} />
            </div>
          </div>
          <div className="modal-footer">
            <button type="button" className="btn btn-secondary" onClick={onClose}>Hủy</button>
